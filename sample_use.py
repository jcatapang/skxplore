...
skx.find_model(dataset, 1, "clustering")

# Test code for classification
dataset = pd.read_csv('datasets/balance-scale.data')
skx.find_model(dataset, 0.8, "classification", label="label", datatype="numerical", dim_reduction=True, components="auto", contains_negative=True, ensembling=True, priority="accuracy")
